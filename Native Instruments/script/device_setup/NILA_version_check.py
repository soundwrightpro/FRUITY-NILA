...
def VersionCheck(compatibility):
    ...
    print("-" * 75)
    print(constants.OUTPUT_MESSAGE, constants.GOODBYE_MESSAGE, "\n")

    # Check if FL Studio version is within the specified range
    DAW_compatible = False
